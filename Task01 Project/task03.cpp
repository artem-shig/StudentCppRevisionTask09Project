 ...
 *
 *	Примечание
 *	1) Постарайтесь реализовать основной алгоритм так, чтобы в нём было
 *	минимальное количество условных конструкций (можно обойтись двумя
 *	вложенными друг в друга условными коснтрукциями).
 *	2) Не забудьте про механизм "защиты от дурака": если номер месяца
 *	некорректен, то нужно возвратить 0. Год может быть отрицательным
 *	(что будет обозначать до нашей эры).
 *
